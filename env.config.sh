...
export LDAP_DOMAIN="ldap.xongl.com"
export LDAP_FULL_DOMAIN="dc=ldap,dc=xongl,dc=com"
...
export LDAP_MANAGER_DN="cn=admin,dc=ldap,dc=xongl,dc=com"
...
export GITLAB_PLATFORM_USERNAME="saqsham"
